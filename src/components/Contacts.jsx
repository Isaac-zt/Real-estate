...
const Contacts = () => {
  ...
  const onSubmit = async (event) => {
    ...
    formData.append("access_key", "56a62359-3b46-4c2e-953b-67c3a6b2c6ee");
  ...
  return (
    ...
    className='text-center py-20 p-6 lg:px-32 w-full overflow-hidden' id='Contact'>
      ...
      <p className='text-center text-gray-500 mb-12 max-w-80 mx-auto'>Ready to find your dream home? Contact us today!</p>
      ...
      <form onSubmit={onSubmit} className='max-w-2xl mx-auto text-gray-600 pt-8'>
        ...
        <button className='bg-blue-600 text-white py-2 px-12 mb-10 rounded-2xl hover:bg-blue-500 duration-300 ease-in-out cursor-pointer'>{result ? result : "Send Message"}</button>
      </form>
    </motion.div>
  )
}
